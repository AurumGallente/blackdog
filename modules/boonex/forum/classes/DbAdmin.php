...
if (!defined('TF_FORUM_VOTE'))       define ('TF_FORUM_VOTE',	    '`'.$gConf['db']['prefix'].'forum_vote`');
if (!defined('TF_FORUM_REPORT'))     define ('TF_FORUM_REPORT',     '`'.$gConf['db']['prefix'].'forum_report`');
if (!defined('TF_FORUM_TOPIC'))      define ('TF_FORUM_TOPIC',	    '`'.$gConf['db']['prefix'].'forum_topic`');
if (!defined('TF_FORUM_FLAG'))       define ('TF_FORUM_FLAG',       '`'.$gConf['db']['prefix'].'forum_flag`');
if (!defined('TF_FORUM_USER_STAT'))  define ('TF_FORUM_USER_STAT',  '`'.$gConf['db']['prefix'].'forum_user_stat`');
